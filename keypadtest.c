...
// * Author: benny
// *
// * Created on May 11, 2021, 9:20 PM
// */
//
//
//#include "CONFIG.h"
...
//    int adc_result = 300; // Vary this value for tests
//
...
//    }
//
///*Test for keypad input and uses a dummy adc value
// Compares adc value to 'ok' range, then plays corresponding sound and turn
//  on fan if required*/
//void main(void) {
//    init();
//    __delay_ms(1000);
